...
@media(max-width:620px){.dialog-backdrop{padding:0;align-items:end}.settings-card{max-height:95vh;border-radius:12px 12px 0 0}.settings-layout{display:block}.settings-layout>nav{padding:8px 14px;border:0;border-bottom:1px solid var(--line);display:grid;grid-template-columns:1fr 1fr;gap:6px}.settings-layout>nav button{min-height:45px}.settings-body{height:calc(95vh - 190px);padding:18px}.category-folders label{grid-template-columns:29px 1fr 8px 105px}footer p{display:none}}
</style>
