...
@container workspace (max-width:1100px){.download-row{grid-template-columns:minmax(180px,1.3fr) minmax(130px,1fr) 90px 68px;gap:12px}.status-cell{display:none}.row-actions button:nth-child(2){display:none}}
