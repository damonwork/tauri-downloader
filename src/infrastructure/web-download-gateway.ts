    ...
    downloads: [
      {
        ...
        transfer: { downloadedBytes: 2_612_000_000, size: { kind: "known", totalBytes: 3_842_000_000 }, validator: { kind: "etag", value: "demo-etag" } }, threads: 12,
      ...
      },
      {
        ...
        transfer: { downloadedBytes: 672_000_000, size: { kind: "known", totalBytes: 1_460_000_000 }, validator: { kind: "none" } }, threads: 8,
      ...
      },
      {
        ...
        transfer: { downloadedBytes: 0, size: { kind: "known", totalBytes: 824_000_000 }, validator: { kind: "none" } }, threads: 6,
      ...
      },
      {
        ...
        transfer: { downloadedBytes: 28_400_000, size: { kind: "known", totalBytes: 28_400_000 }, validator: { kind: "none" } }, threads: 4,
  ...
  private load(): AppSnapshot {
    ...
    try {
      ...
      const sanitized: AppSnapshot = {
        ...parsed,
        downloads: parsed.downloads.map((item) => ({ ...item, source: previewSource(item.source) })),
